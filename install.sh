...
# Explicitly install the production dashboard shell and assets.
install -d "$APP_RUN/frontend/assets"
install -m 0644 "$APP_SRC/frontend/index.html" "$APP_RUN/frontend/index.html"
for asset in dashboard_v3.css dashboard_v3_layout.css dashboard_v3.js dashboard_upgrade.css dashboard_upgrade.js dashboard_upgrade_patch.js dashboard_polish.css dashboard_polish.js dashboard_polling_guard.js; do
