...
Smart Condo Dashboard v1.0.3 is the stable production control center for the
condo automation system. The canonical version is stored in [`VERSION`](VERSION).
The annotated `v1.0.3` tag identifies the current verified release commit;
earlier release tags remain immutable.

## Project status

- Version: **1.0.3**
- Status: v1.0.3 release prepared
...
[`docs/RELEASE_NOTES_v1.0.3.md`](docs/RELEASE_NOTES_v1.0.3.md). Planned work is
...
v1.0.3 ships with the dark glass control-center theme only. A light theme,
